...
<html lang="en">
  <head>
    ...
    <title>Kobe Gym - Edit Trainer</title>
...
<div class="main-container d-flex">
  ...
  <div class="sidebar" id="side_nav">
    ...
    <ul class="list-unstyled px-2 links">
      ...
      <li class=" btn btn-dark link active"><a class="text-decoration-none text-white " href="trainers.php">Manage Trainers</a></li>
    </ul>
    <div class="vr"></div>
  ...
  <div class="article">
    ...
    <h1  class=" title text-center">Edit trainer</h1></div>
    ...
    <div class="col-md-8">
        <table id="datatable" class="table">
                ...
                if(isset($_GET['id']))
                {
                    $trainer_id = mysqli_real_escape_string($con, $_GET['id']);
                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                <label>Trainer for</label>
                                <input type="text" name="trainer_for" value="<?=$trainer['trainer_for'];?>" class="form-control">
                            </div>
                            <div class="mb-3">
                                <button type="submit" name="update_trainer" class="btn btn-primary">
                                    Update trainer
                                </button>
                               
                                <a href="trainers.php" class="btn btn-danger ">Back</a>
