...
<body>
  <nav class="navbar navbar-dark bg-dark px-5">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        ...
        <a class="dropdown-item navLogoutBtn" href="logout.php">Logout</a>
      </div>
    </div>
  </nav>
  <div class="main-container d-flex">
    ...
    <div id="main-container" class="article_index row flex-grow-1 d-flex align-items-center justify-content-center justify-content-evenly mx-0 my-0" style="background-image: url('img/gym_index.jpg'); background-size:cover;">
      <h1 id="title" class=" text-center text-white" style="font-weight: bold;">Kobe Gym Dashboard</h1>
      <div id="cards-container" class="d-flex justify-content-evenly text-center">
        <div class="col-sm-3">
          <div class="card pb-5" style="background-color: rgba(255,255,255, 0.6);">
            <div class="card-body pt-5 pb-3">
              ...
              <p class="card-text text-lg-center text-dark" style="font-weight: bold; font-size: 36px;"><?php echo $count_users; ?></p>
              <div class="text-center">
                <a href="users.php" class="btn btn-primary bg-dark border-white">To users portal</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="card pb-5" style="background-color: rgba(255,255,255, 0.6);">
            <div class="card-body pt-5 pb-3">
              ...
              <p class="card-text text-lg-center text-dark" style="font-weight: bold; font-size: 36px;"><?php echo $count_members; ?></p>
              <div class="text-center">
                <a href="members.php" class="btn btn-primary bg-dark border-white">To members portal</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="card pb-5" style="background-color: rgba(255,255,255, 0.6);">
            <div class="card-body pt-5 pb-3">
              ...
              <p class="card-text text-lg-center text-dark " style="font-weight: bold; font-size: 36px;"><?php echo $count_trainers; ?></p>
              <div class="text-center">
                <a href="trainers.php" class="btn btn-primary bg-dark border-white">To trainers portal</a>
              </div>
            </div>
          </div>
        </div>
